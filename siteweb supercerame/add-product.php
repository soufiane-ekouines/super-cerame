<?php
  ...
  include 'class/produit.php';
   ...
   {
     $title=htmlspecialchars($_POST['title-product']);
        ...
        <section id="main">
            <div class="container">
                <form class="content" method="POST"    enctype="multipart/form-data" autocomplete="off">
                    <label>Title :</label>
                    <input class="btn" type="text" placeholder="Title *" id="title-product" name="title-product" required>

                    <label>Marque :</label>
                    <input class="btn" type="text" value="Super Cérame"  placeholder="Marque *" id="marque-product" name="marque-product" required disable>

                    <label>Collection :</label>
                    <input class="btn" type="text" placeholder="Collection *" id="collection-product" name="collection-product" required>

                    <label>Ajouté par :</label>
                    <input class="btn" type="text" placeholder="Ajouté par *" id="ajoute-par-product" name="ajoute-par-product" required>

                    <label>Taille :</label>
                    <input class="btn" type="text" placeholder="Taille *" id="taille-product" name="taille-product" required>

                    <label>Quantité/Boite :</label>
                    <input class="btn" type="text" placeholder="Quantité/Boite *" id="qte-product" value="12" name="qte-product" required>

                    <label>Stock :</label>
                    <input class="btn" type="text" placeholder="stock *" id="stock-product" name="stock-product" required>
                    
                    <label>prix :</label>
                    <input class="prix-btn btn" type="text" placeholder="0" id="prix-product" name="prix-product" required>
                    
                    <input type="file" id="myFile" name="name" required>
                    <input class="submit-btn" name="ajout" type="submit">
                </from>
            </div>
        </section>
        <!--End main-->
